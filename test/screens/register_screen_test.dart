...
void main() {
  ...
  group('RegisterScreen - AC 1.1.1: Form Validation', () {
    ...
    testWidgets('AC 1.1.1.1: Screen renders without errors', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestableWidget(RegisterScreen()),
      );
    ...
    testWidgets('AC 1.1.1.3: TextFormFields present (at least 4)', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestableWidget(RegisterScreen()),
      );
    ...
    testWidgets('AC 1.1.1.4: Role selection widget present', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestableWidget(RegisterScreen()),
      );
    ...
    testWidgets('AC 1.1.1.5: Register button present', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestableWidget(RegisterScreen()),
      );
    ...
    testWidgets('AC 1.1.1.6: Can enter text in form fields', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestableWidget(RegisterScreen()),
      );
  ...
  group('RegisterScreen - AC 1.1.3: Error Handling', () {
    ...
    testWidgets('AC 1.1.3.1: Submit button present and tapable', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestableWidget(RegisterScreen()),
      );
    ...
    testWidgets('AC 1.1.3.2: Loading state handling', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestableWidget(RegisterScreen()),
      );
  ...
  group('RegisterScreen - Form Structure', () {
    ...
    testWidgets('AC 1.1.1.9: All form elements accessible', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestableWidget(RegisterScreen()),
      );
