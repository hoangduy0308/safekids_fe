...
void main() {
  group('AuthProvider: Offline Auth Persistence Bug Fix', () {
    ...
    test(
      'SCENARIO-001: Offline app startup - should use cached auth',
      () {
        // Steps:
    ...
    test(
      'SCENARIO-002: Real auth error - should logout',
      () {
    ...
    test(
      'SCENARIO-003: Online recovery - should sync when reconnected',
      () {
    ...
    test(
      'SCENARIO-004: User deleted from DB while offline',
      () {
  ...
  group('Auth State Tests', () {
    test(
      'Cached user data should be preserved offline',
      () {
        // AuthService stores:
    ...
    test(
      'Socket should not connect when offline',
      () {
        // During init() offline:
