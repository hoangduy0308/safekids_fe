class GeofenceAlertModel {
  ...
  factory GeofenceAlertModel.fromJson(Map<String, dynamic> json) {
    ...
    return GeofenceAlertModel(
      ...
      geofenceId: geofence is Map ? geofence['_id'] as String : geofence as String,
      geofenceName: geofence is Map ? (geofence['name'] as String? ?? 'Unknown') : 'Unknown',
      geofenceType: geofence is Map ? (geofence['type'] as String? ?? 'safe') : 'safe',
      childId: child is Map ? child['_id'] as String : child as String,
      childName: child is Map ? (child['fullName'] as String? ?? child['name'] as String? ?? 'Unknown') : 'Unknown',
