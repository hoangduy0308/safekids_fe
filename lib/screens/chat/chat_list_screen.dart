...
class _ChatListScreenState extends State<ChatListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Messages',
          style: AppTypography.h2.copyWith(fontSize: 24, fontWeight: FontWeight.w700),
        ),
        actions: [
          Padding(
            ...
            child: GestureDetector(
              ...
              child: Icon(Icons.add_comment, color: AppColors.childPrimary, size: 28),
            ),
          ),
        ],
      ),
            ...
            : _conversations.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final lastMessage = conversation['lastMessageText'] as String?;
  ...
  void _showNewChatDialog(BuildContext context) {
    ...
    if (linkedUsers.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('No linked contacts available')),
      );
      return;
    }
