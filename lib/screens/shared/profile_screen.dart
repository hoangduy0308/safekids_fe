...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
      ...
      body: Stack(
        ...
        child: SlideTransition(
          ...
          child: RefreshIndicator(
            ...
            color: isParent ? AppColors.parentPrimary : AppColors.childPrimary,
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: AppSpacing.md),
                  _buildLinkedAccountsSection(context, linkedAccounts, isParent),
                  SizedBox(height: AppSpacing.md),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: IconButton(
                icon: Icon(Icons.edit, color: isParent ? AppColors.parentPrimary : AppColors.childPrimary),
                onPressed: () {
                  HapticFeedback.lightImpact();
                  Navigator.push(
                    context,
  ...
  Widget _buildModernHeader(BuildContext context, user, bool isParent) {
    ...
    return Container(
      padding: EdgeInsets.fromLTRB(AppSpacing.md, 60, AppSpacing.md, AppSpacing.xl),
      child: Column(
        children: [
              ...
              Container(
                ...
                child: Center(
                  child: Text(
                    ...
                    style: AppTypography.h1.copyWith(color: roleColor).copyWith(
                      fontSize: 52,
                      letterSpacing: -1,
                    ),
                  ),
          ...
          Text(
            user.name,
            style: AppTypography.h1.copyWith(color: AppColors.textPrimary).copyWith(
              fontSize: 32,
              letterSpacing: -0.5,
              height: 1.2,
            ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: AppTypography.body.copyWith(color: roleColor).copyWith(
  ...
  Widget _buildQuickStats(BuildContext context, user, List linkedAccounts, bool isParent) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            value,
            style: AppTypography.h3.copyWith(color: AppColors.textPrimary).copyWith(
              letterSpacing: -0.3,
            ),
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
          ...
          Text(
            label,
            style: AppTypography.caption.copyWith(color: AppColors.textSecondary).copyWith(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  value,
                  style: AppTypography.body.copyWith(color: AppColors.textPrimary).copyWith(
                    fontWeight: FontWeight.w600,
                    letterSpacing: -0.2,
                  ),
                ),
  ...
  Widget _buildLinkedAccountsSection(
      BuildContext context, List<Map<String, dynamic>> accounts, bool isParent) {
    final roleColor = isParent ? AppColors.parentSecondary : AppColors.childPrimary;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (accounts.isEmpty)
            EmptyStateWidget(
              icon: isParent ? Icons.child_care_outlined : Icons.family_restroom_outlined,
              ...
              color: isParent ? AppColors.parentSecondary : AppColors.childPrimary,
            )
          else
            ...accounts.map((account) => _buildAccountCard(account, isParent)).toList(),
        ],
      ),
    );
  }
  ...
  Widget _buildAccountCard(Map<String, dynamic> account, bool isParent) {
    final avatarColor = isParent ? AppColors.childAccent : AppColors.parentPrimary;
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    'Liên kết',
                    style: AppTypography.caption.copyWith(color: AppColors.success).copyWith(
                      fontWeight: FontWeight.w600,
                    ),
                  ),
                ),
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    'Đăng xuất',
                    style: AppTypography.body.copyWith(color: AppColors.danger).copyWith(
                      fontWeight: FontWeight.w600,
                    ),
                  ),
                ],
