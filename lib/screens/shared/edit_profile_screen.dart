      ...
      child: Scaffold(
        ...
        children: [
          SingleChildScrollView(
            ...
            padding: EdgeInsets.fromLTRB(AppSpacing.md, MediaQuery.of(context).padding.top + 60, AppSpacing.md, AppSpacing.xl),
            child: Form(
              key: _formKey,
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: AppTypography.bodySmall.copyWith(color: AppColors.textSecondary).copyWith(
                      fontWeight: FontWeight.w600,
                    ),
                  ),
                  SizedBox(height: AppSpacing.sm),
                  Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.email_outlined, color: AppColors.textSecondary, size: AppSpacing.iconSm),
